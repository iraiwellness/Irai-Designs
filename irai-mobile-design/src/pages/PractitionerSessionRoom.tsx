...
export default function PractitionerSessionRoom() {
  ...
  return (
    <div className="min-h-screen bg-black md:flex md:items-center md:justify-center md:p-4">
      <div className="w-full min-h-screen md:min-h-0 md:max-w-[375px] md:h-[812px] md:rounded-[40px] md:shadow-[0_0_100px_rgba(0,0,0,0.3)] relative overflow-hidden flex flex-col">
